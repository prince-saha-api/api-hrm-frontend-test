...
const Index = () => {
  ...
  let apiUrl = `/api/leave/get-leavepolicy/?page=${currentPage}&page_size=${pageSize}&column_accessor=${
  ...
  const columns = [
    ...
    {
      // for table display
      accessor: "allocation_days",
      title: "Allocation Days",
      // visibleMediaQuery: aboveXs,
      sortable: true,
      render: ({ allocation_days }) => allocation_days || "N/A",
      // for export
      key: "allocation_days",
    },
    {
      // for table display
      accessor: "max_consecutive_days",
      title: "Max Consecutive Days",
      // visibleMediaQuery: aboveXs,
      sortable: true,
      render: ({ max_consecutive_days }) => max_consecutive_days || "N/A",
      // for export
    ...
    },
    {
      ...
      title: "Leave Type",
      // visibleMediaQuery: aboveXs,
      render: ({ leave_type }) => leave_type || "N/A",
      // for export
      key: "leave_type",
    },
    {
  ...
  const handleChange = (keys) => {
    const updatedKeys = [
      ...new Set(["na", "name", "leave_type", "actions", ...keys]),
    ];
